angular.module('ionMdInputDisabled', [])

.directive('ionMdInputDisabled', function() {
  return {
    restrict: 'E',
    replace: true,
    require: '?ngModel',
    template: '<label class="item item-input item-md-label" style="border-style: none;">' +
      '<input readonly type="text" class="md-input" style="color:lightgray !important; border-bottom: thin; border-bottom-color: white; border-bottom-style: solid">' +
